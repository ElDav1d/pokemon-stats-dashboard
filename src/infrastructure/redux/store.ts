...
const persistenceMiddleware = createPersistenceMiddleware<RootState>(persistenceConfig);
const preloadedState = loadStateFromLocalStorage<RootState>(persistenceConfig.storageKey);
